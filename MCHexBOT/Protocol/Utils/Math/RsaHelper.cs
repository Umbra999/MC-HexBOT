		...
		public static RSA DecodePublicKey(byte[] publicKeyBytes)
		{
			...
			try
			{
				...
				switch (shortValue)
				{
					...
					default:
						Logger.LogError($"PublicKey Decode Returning null!");
				...
				{
					Logger.LogError($"PublicKey Decode Returning null! (shortvalue 1)");
				...
				if (byteValue != 0x00)
				{
					Logger.LogError($"PublicKey Decode Returning null! (bytevalue)");
				...
				{
					Logger.LogError($"PublicKey Decode Returning null! (Shortvalue 2)");
			...
			{
				Logger.LogError($"PublicKey Decode Exception: {e}");
